...
| 3. Customer Risk & Unit Economics | Where should we act? | Feature usage against churn, NPS against churn, support behaviour, active high-risk customer table, estimated CLV by plan, CLV:CAC |
